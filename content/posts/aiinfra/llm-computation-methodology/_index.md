...
layout = 'single'
math = false
summary = '从 config.json 到参数量、FLOPs、KV Cache、推理显存、训练显存、通信分析、推理服务建模的完整系统推演。全系列 7 篇，基于 8 个开源模型的实战拆解经验。'
+++
...
| 7 | [推理服务性能建模](part-7/) | 连续批处理 → PagedAttention → PD 分离 → 推测解码 → Llama-70B 服务分析 → MoE serving |
